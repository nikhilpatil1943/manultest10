  ...
  return (
    <div className="Hero">
      <div className="Hero__content">
        <div className="Hero__Oneline" style={{ color: "black" }}>
          Simplify your
          <span className="hero__green"> restaurant management</span> with our
          all-in-one platform.
        </div>
      ...
      <img src={HeroImg} alt="Home-hero" className="Hero__img" />
